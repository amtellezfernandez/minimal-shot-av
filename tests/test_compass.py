...
from minimal_shot_av.policy import run_spotlight_reflex_policy
...
class CompassTests(unittest.TestCase):
    ...
    def test_loads_custom_compass_profile_json(self) -> None:
                ...
                json.dumps(
                    {
                        ...
                        "score_weights": {"trajectory": 1.0, "recovery": 0.0, "generalization": 0.0},
        ...
        self.assertEqual(profile.score_weights.trajectory, 1.0)
        ...
        self.assertEqual(report["summary"]["official_score_formula"], "1.00*trajectory + 0.00*recovery + 0.00*generalization")
