...
MODEL_SCRIPTS = {
    ...
    "analyze_candidate_recoverable_regret.py",
    "analyze_nuplan_replay_utility_barrier.py",
    "attach_candidate_metrics.py",
    "build_candidate_regret_curriculum.py",
    "convert_onevl_inference_to_candidate_sets.py",
    "run_candidate_regret_pipeline.py",
    "run_corl_replay_value_repeated_splits.py",
    "run_nuplan_bootstrap_candidate_loop.py",
    "run_nuplan_maneuvertoken_rollout.py",
    "run_nuplan_recoverable_regret_bootstrap.py",
    "summarize_candidate_regret_lifecycle.py",
    "train_nuplan_bootstrap_student_generator.py",
    "train_nuplan_failure_gate_selector.py",
    "train_nuplan_regime_gate_selector.py",
    "train_nuplan_regime_value_selector.py",
    "validate_candidate_generator_dump.py",
...
NEUTRAL_SCRIPTS = {
    ...
    "build_corl_boundary_consistency_audit.py",
    "build_corl_replay_value_comparison.py",
