...
\end{axis}
\end{tikzpicture}
\caption{Holdout safety--utility border on the expanded 21-token bank. The scene-token
student remains far above the oracle failure boundary. Candidate-level replay value (RV)
reaches the same 0.097 failure line as the oracle, and the balanced RV point retains more
progress than the safety-heavy point while staying on that boundary.}
