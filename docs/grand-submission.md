...
trajectory selector reaching 7.880 RFS (+0.86 over the 7.022 constant-velocity
baseline) on 479 validation frames under segment-grouped cross-validation. It is
...
| WOD-E2E champion (HGB stability-selected) | 7.880 RFS | 479-frame validation CV — commit `69b4efb` |
| WOD-E2E oracle (best candidate per frame) | 9.068 RFS | 479-frame validation CV |
