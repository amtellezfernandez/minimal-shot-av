...
REQUIRED_MEMBERS = {
    "grand_commission": {
        ...
        "grand_commission/artifacts/wod_fastkin_gate_ridge175_scene016_cv_official.json",
        "grand_commission/artifacts/wod_fastkin_gate_ridge175_scene016_breakthrough_audit.json",
