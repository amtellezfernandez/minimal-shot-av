...
def main() -> int:
    ...
    parser.add_argument("--val-dir", type=Path, default=ROOT / "waymo_open_dataset_end_to_end_camera_v_1_0_0" / "val")
    ...
    parser.add_argument("--waymo-src", type=Path, default=ROOT / "waymo-open-dataset" / "src")
