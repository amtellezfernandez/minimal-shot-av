...
- Objective: `-250.0 * replay_failure + 1.0 * progress - 0.0 * ADE3`
...
| replay_value | 237 | 0.339 | 182/186 | 18.665 | 5.553 | 9.245 | 2.511 |
...
- `replay_value`: `{"crawl": 19, "evasive_left": 77, "evasive_right": 144, "lane_recover": 6, "maintain": 201, "nudge_left": 10, "nudge_right": 12, "slow_yield": 54, "stop": 177}`
...
| replay_value | 49 | 0.163 | 160/160 | 11.712 | 9.230 | 15.142 | 2.114 |
...
- `replay_value`: `{"crawl": 21, "evasive_left": 40, "evasive_right": 8, "maintain": 40, "nudge_left": 2, "slow_yield": 39, "stop": 150}`
