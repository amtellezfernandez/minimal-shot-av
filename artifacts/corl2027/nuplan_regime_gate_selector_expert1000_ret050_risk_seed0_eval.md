...
| regime_gate | 237 | 0.339 | 181/186 | 22.297 | 4.081 | 6.936 | 2.581 |
| risk_regime_gate | 259 | 0.370 | 159/186 | 22.627 | 3.987 | 6.824 | 2.620 |
...
- Predicted regimes: `{"intervention": 95, "keep_proxy": 455, "marginal_correction": 150}`
...
- `regime_gate`: `{"crawl": 25, "evasive_left": 7, "evasive_right": 148, "lane_recover": 78, "maintain": 219, "nudge_left": 3, "nudge_right": 33, "slow_yield": 127, "stop": 60}`
- `risk_regime_gate`: `{"crawl": 20, "evasive_left": 9, "evasive_right": 158, "lane_recover": 85, "maintain": 217, "nudge_left": 7, "nudge_right": 43, "slow_yield": 106, "stop": 55}`
...
| regime_gate | 58 | 0.193 | 151/160 | 19.355 | 5.989 | 9.672 | 2.543 |
| risk_regime_gate | 67 | 0.223 | 142/160 | 19.491 | 5.784 | 9.224 | 2.717 |
...
- Predicted regimes: `{"intervention": 87, "keep_proxy": 117, "marginal_correction": 96}`
- Introduced failures: `0`
...
- `regime_gate`: `{"crawl": 60, "evasive_left": 21, "evasive_right": 13, "lane_recover": 9, "maintain": 60, "nudge_right": 10, "slow_yield": 101, "stop": 26}`
- `risk_regime_gate`: `{"crawl": 63, "evasive_left": 62, "evasive_right": 13, "lane_recover": 13, "maintain": 38, "nudge_right": 16, "slow_yield": 72, "stop": 23}`
