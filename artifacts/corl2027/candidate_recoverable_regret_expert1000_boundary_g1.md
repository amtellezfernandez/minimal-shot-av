...
- Input: `artifacts/corl2027/nuplan_bootstrap_candidate_loop_expert1000_boundary_g1_replay.json`
- Scenes: `1000`
- Valid scenes: `1000`
...
| Metric | Value |
|---|---:|
| mean top-1 value | -62.380 |
| mean oracle@K value | -54.083 |
| mean recoverable regret | 8.297 |
| positive regret rate | 0.391 |
