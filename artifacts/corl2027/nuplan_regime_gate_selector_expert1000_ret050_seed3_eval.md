...
| regime_gate | 104 | 0.149 | 276/276 | 19.158 | 4.752 | 7.974 | 2.636 |
...
- Predicted regimes: `{"intervention": 134, "keep_proxy": 387, "marginal_correction": 179}`
...
- `regime_gate`: `{"crawl": 91, "evasive_left": 37, "evasive_right": 36, "lane_recover": 56, "maintain": 201, "nudge_left": 2, "nudge_right": 37, "slow_yield": 200, "stop": 40}`
...
| regime_gate | 192 | 0.640 | 55/70 | 29.482 | 3.382 | 5.471 | 2.234 |
...
- Predicted regimes: `{"intervention": 17, "keep_proxy": 215, "marginal_correction": 68}`
- Introduced failures: `0`
...
- `regime_gate`: `{"crawl": 1, "evasive_left": 7, "evasive_right": 112, "lane_recover": 28, "maintain": 98, "nudge_right": 9, "slow_yield": 29, "stop": 16}`
