...
| regime_gate | 286 | 0.338 | 254/264 | 23.904 | 4.049 | 6.796 | 2.618 |
...
- Predicted regimes: `{"intervention": 81, "keep_proxy": 529, "marginal_correction": 235}`
...
- `regime_gate`: `{"crawl": 29, "evasive_left": 36, "evasive_right": 164, "lane_recover": 81, "maintain": 266, "nudge_left": 3, "nudge_right": 38, "slow_yield": 176, "stop": 52}`
...
| regime_gate | 49 | 0.316 | 38/82 | 18.857 | 3.497 | 5.389 | 2.274 |
| replay_oracle | 5 | 0.032 | 82/82 | 9.125 | 7.570 | 12.098 | 2.218 |

### Regime Diagnostics

- Oracle regimes: `{"intervention": 71, "keep_proxy": 73, "marginal_correction": 11}`
- Predicted regimes: `{"intervention": 32, "keep_proxy": 81, "marginal_correction": 42}`
- Introduced failures: `0`
...
- `regime_gate`: `{"crawl": 32, "evasive_left": 4, "lane_recover": 8, "maintain": 25, "nudge_right": 47, "slow_yield": 39}`
