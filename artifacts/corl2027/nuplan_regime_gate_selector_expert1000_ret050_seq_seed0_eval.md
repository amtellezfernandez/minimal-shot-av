...
| regime_gate | 246 | 0.351 | 172/186 | 23.123 | 3.805 | 6.508 | 2.549 |
...
- Predicted regimes: `{"intervention": 64, "keep_proxy": 472, "marginal_correction": 164}`
...
- `regime_gate`: `{"crawl": 18, "evasive_left": 7, "evasive_right": 151, "lane_recover": 79, "maintain": 229, "nudge_left": 5, "nudge_right": 39, "slow_yield": 126, "stop": 46}`
...
| regime_gate | 115 | 0.383 | 94/160 | 25.194 | 3.522 | 5.485 | 2.358 |
...
- Predicted regimes: `{"intervention": 15, "keep_proxy": 180, "marginal_correction": 105}`
- Introduced failures: `0`
...
- `regime_gate`: `{"crawl": 10, "evasive_left": 20, "evasive_right": 13, "lane_recover": 9, "maintain": 74, "nudge_right": 58, "slow_yield": 111, "stop": 5}`
