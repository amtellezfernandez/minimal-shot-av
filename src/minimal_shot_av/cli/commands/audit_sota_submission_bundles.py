...
DEFAULT_WAYMO_DATA_ROOT = ROOT / "workspace" / "waymo_open_dataset_end_to_end_camera_v_1_0_0"
...
REQUIRED_MEMBERS = {
    "grand_commission": {
        ...
        "grand_commission/docs/sota-grand-slide-deck.md",
        ...
        "grand_commission/docs/preference-calibrated-evidence.md",
        "grand_commission/docs/fast-slow-realtime-architecture.md",
    ...
    "minor_commission": {
        ...
        "minor_commission/artifacts/minor_visual_gallery/index.html",
    },
}
