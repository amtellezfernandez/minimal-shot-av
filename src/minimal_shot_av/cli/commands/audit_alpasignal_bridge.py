...
def build_report() -> dict[str, Any]:
    ...
    return {
        ...
        "adapter": "minimal_shot_av.simulator.alpasim_spotlight:SpotlightReflexAlpaSimModel",
        "claim": (
            "AlpaSignal/AlpaSim bridge converts route command, camera brightness, ego dynamics, "
            "and optional structured hazards into Spotlight Reflex simulator scenarios."
        ),
        "cases": cases,
        "gates": gates,
        "boundary": (
            "This is a trajectory-plugin and structured-signal bridge. It is not a full "
