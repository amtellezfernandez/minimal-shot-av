...
class DirectActorPlannerAlpaSimModel(BaseTrajectoryModel):
    ...
    def from_config(
        ...
        oracle_path = os.getenv(
            "MSA_DIRECT_PLANNER_ORACLE_ACTOR_PROXY_PATH",
            str(_cfg_value(model_cfg, "oracle_actor_proxy_path", "") or ""),
        ).strip()
        log_path = os.getenv(
            "MSA_DIRECT_PLANNER_LOG_PATH",
        ...
        return cls(
            ...
            oracle_actor_proxy_tolerance_us=int(
                os.getenv(
                    "MSA_DIRECT_PLANNER_ORACLE_ACTOR_PROXY_TOLERANCE_US",
    ...
    def predict(self, prediction_input: PredictionInput) -> ModelPrediction:
        ...
        reasoning_payload = {
            "adapter": "minimal_shot_av.simulator.alpasim_direct_actor_planner",
            "command": command,
