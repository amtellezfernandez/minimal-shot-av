...
from .spotlight_reflex import Trajectory
...
def trajectory_features(
    ...
    *,
    ...
    features: dict[str, float | int | str] = {
        ...
        "mean_abs_heading_change": float(sum(abs(value) for value in heading_changes) / len(heading_changes)) if heading_changes else 0.0,
